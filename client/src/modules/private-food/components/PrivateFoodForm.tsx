...
export default function PrivateFoodForm({
  ...
  return (
    <form onSubmit={onSubmit} className="bg-white dark:bg-neutral-900 rounded-3xl border border-neutral-200/80 dark:border-neutral-800/80 p-6 sm:p-8 shadow-sm transition-colors duration-300">
      {/* Header */}
      <div className="flex items-center justify-between mb-6 sm:mb-8">
        <div>
          <h2 className="text-lg sm:text-xl font-extrabold text-neutral-950 dark:text-neutral-100 tracking-tight transition-colors duration-300">
      ...
      <div className="flex flex-col gap-5 sm:gap-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            <span className="text-[10px] font-extrabold text-neutral-400 dark:text-neutral-500 uppercase tracking-[0.12em] transition-colors duration-300">
              Nome do alimento
            </span>
          </div>
          <input
            ...
            className="w-full text-lg sm:text-xl font-bold text-neutral-950 dark:text-neutral-100 bg-transparent outline-none border-b-2 border-neutral-200 dark:border-neutral-800 focus:border-red-500 pb-1 transition-colors duration-150 placeholder:text-neutral-300 dark:placeholder:text-neutral-600 placeholder:font-medium"
          />
          {errors.name && <p className={errorClass}>{errors.name.message}</p>}
        </div>

        {/* Porção */}
        <div className="bg-neutral-50 dark:bg-neutral-950 border border-neutral-100 dark:border-neutral-800 rounded-2xl px-4 sm:px-8 py-5 sm:py-7 transition-colors duration-300">
          <div className="flex items-center gap-2 mb-4 sm:mb-6">
            <span className="text-[10px] font-extrabold text-neutral-500 dark:text-neutral-400 uppercase tracking-[0.12em] transition-colors duration-300">Porção de referência</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3">
            <input
              ...
              disabled={isPending}
              className="font-display text-3xl sm:text-5xl font-extrabold text-neutral-950 dark:text-neutral-100 leading-none tabular-nums bg-transparent outline-none text-center min-w-0 flex-1 border-b-2 border-neutral-300 dark:border-neutral-700 focus:border-neutral-950 dark:focus:border-neutral-100 pb-1 cursor-text transition-colors duration-150 disabled:opacity-50 disabled:cursor-not-allowed placeholder:text-neutral-300 dark:placeholder:text-neutral-600 placeholder:font-medium"
            />
            <PencilSimple size={18} weight="bold" className="text-neutral-400 dark:text-neutral-500 shrink-0 -mb-1 transition-colors duration-300" />
          </div>
          {errors.servingSize && <p className="text-center text-[11px] font-bold text-red-500 mt-1.5">{errors.servingSize.message}</p>}
        </div>

        {/* Calorias */}
        <div className="rounded-2xl bg-linear-to-br from-red-50 dark:from-red-950/40 to-red-100/40 dark:to-red-950/40 border border-red-100 dark:border-red-900 px-4 sm:px-8 py-5 sm:py-7 transition-colors duration-300">
          <div className="flex items-center gap-2 mb-4 sm:mb-6">
            <Fire size={14} weight="fill" className="text-red-500" />
            <span className="text-[10px] font-extrabold text-red-600 uppercase tracking-[0.12em] transition-colors duration-300">Calorias por porção</span>
          </div>
          ...
          <div className="flex items-center justify-center gap-2 sm:gap-3">
            ...
            />
            <PencilSimple size={18} weight="bold" className="text-red-400 shrink-0 -mb-1 transition-colors duration-300" />
          </div>
        ...
        {mode === 'edit' ? (
          <div className="flex gap-3 pt-2">
            <button
              ...
              onClick={onCancel}
              disabled={isPending}
              className="flex-1 py-3.5 rounded-xl border border-neutral-200 dark:border-neutral-800 text-sm font-semibold text-neutral-600 dark:text-neutral-400 hover:bg-neutral-50 dark:hover:bg-neutral-900 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Cancelar
            </button>
            <button
