...
import PrivateFoodForm from './PrivateFoodForm'
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-xs text-neutral-400">
              {search.trim().length >= 2
                ...
                : 'Cadastre seu primeiro alimento acima'}
            </p>
          </div>
        ) : (
          <PrivateFoodList foods={filteredFoods} onEdit={form.startEdit} />
        )}
      </div>
    </div>
  )
