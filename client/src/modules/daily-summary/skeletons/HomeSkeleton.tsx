  ...
  return (
    <div className="animate-pulse px-6 sm:px-10 lg:px-16 py-10 sm:py-12 min-h-screen space-y-5">
      <div className="space-y-2 mb-10">
        ...
        <div className="h-12 w-64 rounded-full bg-neutral-200 dark:bg-neutral-800" />
        <div className="h-7 w-72 rounded-full bg-neutral-200 dark:bg-neutral-800" />
      </div>
        ...
        <div className="p-5 sm:p-6">
          <div className="grid grid-cols-7 gap-2 sm:gap-2.5">
            {[...Array(7)].map((_, i) => (
              ...
              >
                <div className="h-5 bg-neutral-100 dark:bg-neutral-800" />
                <div className="flex-1 flex flex-col items-center justify-center gap-1.5">
                  <div className="h-5 w-4 rounded-full bg-neutral-200 dark:bg-neutral-800" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <div className="bg-white dark:bg-neutral-900 rounded-3xl p-8 space-y-6 shadow-sm transition-colors duration-300">
          <div className="flex justify-between">
            ...
            <div className="h-9 w-24 rounded-2xl bg-neutral-100 dark:bg-neutral-800" />
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
            {[...Array(4)].map((_, i) => (
              <div key={i} className="space-y-2">
                <div className="flex justify-between">
                  <div className="h-2.5 w-14 rounded-full bg-neutral-200 dark:bg-neutral-800" />
          ...
          {[...Array(4)].map((_, i) => (
            <div key={i} className="flex items-center gap-4 bg-white dark:bg-neutral-900 rounded-3xl p-5 shadow-sm transition-colors duration-300">
              ...
              <div className="flex-1 space-y-1.5">
                ...
                <div className="h-2.5 w-48 rounded-full bg-neutral-200 dark:bg-neutral-800" />
              </div>
