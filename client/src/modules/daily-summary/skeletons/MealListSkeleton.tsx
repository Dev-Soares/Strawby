    ...
    <div className="animate-pulse space-y-3">
      ...
      {[...Array(3)].map((_, i) => (
        <div key={i} className="flex items-center gap-4 bg-white dark:bg-neutral-900 rounded-2xl sm:rounded-3xl p-4 sm:p-5 shadow-sm transition-colors duration-300">
          <div className="w-11 h-11 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-neutral-100 dark:bg-neutral-800" />
      ...
      <div className="h-14 rounded-2xl sm:rounded-3xl border border-dashed border-neutral-200 dark:border-neutral-800" />
    </div>
  )
}
