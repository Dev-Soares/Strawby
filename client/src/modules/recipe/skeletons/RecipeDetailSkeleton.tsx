  ...
  <div className="animate-pulse px-4 sm:px-10 lg:px-16 pt-10 pb-8 sm:py-12 max-w-3xl mx-auto">
    <div className="flex items-center gap-4 mb-8">
      ...
      <div className="flex-1">
        <div className="h-10 w-48 rounded bg-neutral-100 mb-2" />
        <div className="h-4 w-24 rounded bg-neutral-100" />
      </div>
    </div>

    <div className="bg-white rounded-2xl border border-neutral-200 p-5 sm:p-6 mb-6">
      <div className="h-4 w-32 rounded bg-neutral-100 mb-5" />
    ...
    <div className="h-4 w-40 rounded bg-neutral-100 mb-4" />
    <div className="flex flex-col gap-3">
      {Array.from({ length: 3 }).map((_, i) => (
        <div key={i} className="bg-white rounded-2xl border border-neutral-200 p-4 sm:p-5">
          <div className="flex items-center justify-between gap-3 mb-3">
            <div className="flex-1">
              <div className="h-4 w-32 rounded bg-neutral-100 mb-2" />
              <div className="h-3 w-16 rounded bg-neutral-100" />
            </div>
            <div className="h-6 w-12 rounded bg-neutral-100" />
          </div>
