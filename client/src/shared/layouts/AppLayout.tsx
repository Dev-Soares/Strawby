...
export default function AppLayout({ children }: AppLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      <div className={`sticky top-0 z-60 transition-colors duration-300 ${menuOpen ? 'bg-transparent' : 'bg-neutral-50/80 backdrop-blur-md'}`}>
      ...
      <button
        ...
        className="fixed top-2 right-2 sm:top-3 sm:right-4 md:top-5 md:right-4 z-70 flex flex-col gap-1.5 sm:gap-2 cursor-pointer p-2"
